...
function geoCodeLocation(location, serverLocationData) {
  const settings = {
    ...
    success: function(data) {
      STATE.current.location = data.results[0].geometry.location; //move these to .then() to make this function more generic and reusable
      STATE.map.panTo(STATE.current.location);  //give control to function that calls this
    },
    error: function(){
      console.log('error');
    }
  };
  return $.ajax(settings);  //return $.ajax(settings) to return a promise, which is thenable
}
//--------------------------------------------
function initMap() {
  const mapOptions = {
...
$(window).on('load', function() {
  ...
  $('#about').on('click', function(event) {
    ...
    $('.js-user-form').html(`
      ...
      <div class="aboutText">
        ...
        <p class = "aboutText">Please direct any questions, comments, or concerns to <a href="mailto:benparman@gmail.com">benparman@gmail.com</a></p></p>
        </div>
  ...
  $('#contact').on('click', function(event) {
    ...
    $('.js-user-form').html(`
      <div class="about">
      <div class="aboutText">
        <p class = "aboutText">Please direct any questions, comments, or concerns to <a href="mailto:benparman@gmail.com">benparman@gmail.com</a></p>
        </div>
        <button class="closeUserForm" id="closeAbout" type="button">Close</button>
      </div>
      `
